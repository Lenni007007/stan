...
class PlotlyGraph:
    def __init__(self, graph_title: object, random_colors: object = False, y_type: object = None) -> object:
        ...
        self.layout.update(legend=dict(orientation='h', xanchor='center', y=-0.3))
    ...
    def append_data(self, name: str, x: list, y: list=[], y2: bool = False, sma: bool = False, sma_interval: int = 5, line_color: list = {}, line_type: str = 'line' ):
        if line_color == {}:
        ...
        if line_type == 'line':
            ...
            if y2:
                ...
                self.layout.update(yaxis2=dict(title=self.layout[ 'yaxis2' ]['title'], showline=True, anchor='x', overlaying='y',
            ...
            scatter_params['line'] = plotly.graph_objs.scatter.Line(width=2, color=line_color)
            ...
            if sma:
                ...
                ma_scatter_params['line'] = plotly.graph_objs.scatter.Line(width=2, color=line_color)
    ...
    def add_vertical_line(self, x, color='rgb(55, 128, 191)', width=3, name=None):
        if name != None:
            scatter_params = dict()
    ...
    def add_horizontal_line(self, y, color='rgb(55, 128, 191)', width=3, name=None):
        if name != None:
            scatter_params = dict()
